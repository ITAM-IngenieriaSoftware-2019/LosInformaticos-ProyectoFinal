...
El beneficio de este sistema es que permitirá un fácil y sencillo proceso de pedir un RappiITAM para los alumnos, tomando en cuenta que muchos alumnos no tienen tiempo para poder salir a comer o para comprar algo de comer (sobre todo en temporada de exámenes finales) y checando que no falle al momento de realizar algún pedido. La meta del sistema es que los alumnos no tengan dificultades para realizar pedidos de RappiITAM y que las ventanas del sistema sean agradables y de fácil uso para los usuarios.
